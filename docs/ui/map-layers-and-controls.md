...
- elevation relief supports two runtime states: `off` and `100% land coverage`
...
- hillshade is not loaded/rendered in the web app (memory-saving decision)
- sea bathymetry rendering is intentionally out of scope for the active hypsometric mode
