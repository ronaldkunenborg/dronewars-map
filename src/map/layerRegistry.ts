...
export const mapLayerVisibilityTargets = {
  ...
  oblasts: [
    ...
    "country-label-fallback-latin",
    "country-label-fallback-cyrillic",
...
const orderedLayerRegistry: OrderedLayerDefinition[] = [
  ...
  },
  {
    ...
    build: (sourceId) => [
      ...
      {
        id: "country-label-fallback-latin",
        type: "symbol",
        source: sourceId,
        filter: [
          "all",
          ["==", ["coalesce", ["get", "labelScript"], "latin"], "latin"],
          ["<", ["coalesce", ["get", "labelWidthDeg"], 0], 7],
        ],
        minzoom: 4,
        layout: {
      ...
      {
        id: "country-label-fallback-cyrillic",
        type: "symbol",
        source: sourceId,
        filter: [
          "all",
